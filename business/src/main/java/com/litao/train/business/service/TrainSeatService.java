...
import com.litao.train.business.domain.TrainSeatExample;
import com.litao.train.business.mapper.TrainSeatMapper;
import com.litao.train.business.req.TrainSeatQueryReq;
import com.litao.train.business.req.TrainSeatSaveReq;
import com.litao.train.business.resp.TrainSeatQueryResp;
...
public class TrainSeatService {
    ...
    public void genTrainSeat(String trainCode){
        ...
        LOG.info("当前车次下的车箱数：{}",carriages.size());
        ...
        for (TrainCarriage carriage : carriages) {
            ...
            //根据车厢的作为类型，筛选出所有的列，比如车厢类型是一等座，则筛选出columnList={ACDF}
            ...
            for (int row=1;row<=rowCount;row++){
                ...
                for(SeatColEnum seatColEnum : colEnumList){
                    ...
                    seat.setCol(seatColEnum.getCode());
