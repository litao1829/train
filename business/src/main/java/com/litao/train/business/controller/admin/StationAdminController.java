...
import com.litao.train.business.req.StationQueryReq;
import com.litao.train.business.req.StationSaveReq;
...
public class StationAdminController {
    ...
    public CommonResp<List<StationQueryResp>> queryList(){
        List<StationQueryResp> resps = stationService.queryAll();
        return new CommonResp<List<StationQueryResp>>(resps);
    }
